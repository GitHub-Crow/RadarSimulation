...
xlabel('Azimuth (sample no. within this block)  \rightarrow', 'FontSize', 12 )
ylabel('Magnitude  (dB)  \rightarrow', 'FontSize', 12 )
title('AGC attenuation values for this block of data', 'FontSize', 13 )
